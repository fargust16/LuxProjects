...
class Settings extends Component {
	...
	resizeWidth() {
		this.setState({showPasswordOptions: window.innerWidth >= 767 ? this.state.showPasswordOptions : false});
		this.setState({showEmailOptions: window.innerWidth >= 767 ? this.state.showEmailOptions : false});
	}
