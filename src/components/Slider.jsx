...
export default class Slider extends Component {
    ...
    _calcBlockOffset(block) {
        let margins, bOffset;
        margins = parseInt(getComputedStyle(block).marginRight, 10) + parseInt(getComputedStyle(block).marginLeft, 10);
    ...
    render() {
        ...
        return (
            <div ref={(div) => {
                ...
                <ControlButtons transformFunc={() => this.endSwitchTransform(1)}
                                btnDirect={1}
