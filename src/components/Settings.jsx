...
class Settings extends Component {
  ...
  resizeWidth() {
    this.setState({showPasswordOptions: window.innerWidth >= 768 ? this.state.showPasswordOptions : false});
    this.setState({showEmailOptions: window.innerWidth >= 768 ? this.state.showEmailOptions : false});
  }
      ...
      <article className="other-pages">
        ...
        <article className="options settings__options">
          <section className="option">
            <div onClick={this.showExternalOptions.bind(this.showExternalOptions, 'email-settings')} className={this.state.showEmailOptions ? "header_lines option__header open-header" : "header option__header close-header"}><span className="header__text">Change email</span></div>
          ...
          <section className="option">
            <div onClick={this.showExternalOptions.bind(this.showExternalOptions, 'password-settings')} className={this.state.showPasswordOptions ? "header_lines option__header open-header" : "header option__header close-header"}><span className="header__text">Change password</span></div>
